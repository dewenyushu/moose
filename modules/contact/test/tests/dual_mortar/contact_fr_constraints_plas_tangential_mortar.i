...
[Materials]
  ...
  [./stress_left]
    ...
    inelastic_models = 'power_law_creep_left'
    block = 1
  [../]
  [./power_law_creep_left]
  ...
  [./stress_right]
    type = ComputeMultipleInelasticStress
    inelastic_models = 'power_law_creep_right'
    block = 2
  [../]
  [./power_law_creep_right]
    type = PowerLawCreepStressUpdate
    coefficient = 1.0e-15
    n_exponent = 4
    activation_energy = 3.0e5
...
[Executioner]
  ...
  petsc_options_iname = '-pc_type -pc_factor_shift_type -pc_factor_shift_amount -snes_test_jacobian'
  petsc_options_value = 'lu NONZERO   1e-15 1e-7'
