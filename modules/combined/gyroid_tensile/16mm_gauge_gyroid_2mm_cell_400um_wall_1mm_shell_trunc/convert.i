[Mesh]
  [file]
    ...
    file = 16mm_gauge_gyroid_2mm_cell_400um_wall_1mm_shell_trunc.unv
  []
  ...
  [traction_bottom]
    ...
    combinatorial_geometry = 'abs(y+2.5)<16e-3' # 25mm from the center origin is the top/bottom face
    #normal = '0 0 -1'
