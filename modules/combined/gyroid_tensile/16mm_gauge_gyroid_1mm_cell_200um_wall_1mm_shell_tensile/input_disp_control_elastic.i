...
# specimen length = 50mm
# maximum displacement 2.5mm (5% deformation)
# total time 100s, timestep size 0.25s
# displacement per step, 0.025 * 0.25 mm
[Mesh]
  [fmg]
    type = FileMeshGenerator
    file = 16mm_gauge_gyroid_1mm_cell_200um_wall_1mm_shell_tensile.e
  []
[]
...
[Modules/TensorMechanics/Master]
  [all]
    ...
    generate_output = 'stress_xx stress_yy stress_xy stress_yz stress_zz strain_xx strain_yy '
                      'strain_xy strain_xz strain_yz strain_zz '
  []
[]
...
[BCs]
  ...
  [top_y]
    ...
    variable = disp_y
    boundary = traction_top
    function = 0.025*t # tension & displacement control
  []
...
[Materials]
  ...
  []
  [stress]
    type = ComputeFiniteStrainElasticStress # need finite strain assumption
  []
[]
...
[Outputs]
  file_base = './output/input_disp_control_elastic_out'
  exodus = true
  [check_point]
    type = Checkpoint
    interval = 20
