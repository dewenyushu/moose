[Mesh]
  [file]
    ...
    file = 16mm_gauge_gyroid_3mm_cell_600um_wall_1mm_shell_trunc_ref3.unv
  []
  ...
  [traction_bottom]
    ...
    combinatorial_geometry = 'abs(y+2.5)<12e-3' # 25mm from the center origin is the top/bottom face
    #normal = '0 0 -1'
