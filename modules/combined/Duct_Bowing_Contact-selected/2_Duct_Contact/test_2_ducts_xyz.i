...
[Postprocessors]
  ...
  [aclp_force]
    ...
    expression = 'sqrt(aclp_force_x*aclp_force_x + aclp_force_y*aclp_force_y+aclp_force_z*aclp_force_z)'
    pp_names = 'aclp_force_x aclp_force_y aclp_force_z'
  []
  [tlp_force_x]
    type = NodalSum
    variable = tlp1_2_contact_x
  ...
  [tlp_force]
    type = ParsedPostprocessor
    expression = 'sqrt(tlp_force_x*tlp_force_x + tlp_force_y*tlp_force_y+tlp_force_z*tlp_force_z)'
    pp_names = 'tlp_force_x tlp_force_y tlp_force_z'
  []
[]
