...
[Problem]
  ...
  restart_file_base = ./Path_T${T_melt}_P${Power}_r${Radius}_h10_coarse/EA_thermal_out_cp/LATEST
[]

[Mesh]
  # [./mesh]
  #   type = FileMeshGenerator
  #   file = ./INL_logo_height10.e
  # [../]
  # [./add_set1]
  ...
  #   normal = '0 0 1'
  # []
  file = ./Path_T${T_melt}_P${Power}_r${Radius}_h10_coarse/EA_thermal_out_cp/LATEST
...
[Functions]
  [./heat_source_x]
    ...
    data_file = ./input_params/path_t_x_h10.csv
    format = columns
    scale_factor = 1.0
  [../]
  [./heat_source_y]
    type = PiecewiseLinear
    data_file = ./input_params/path_t_y_h10.csv
    format = columns
    scale_factor = 1.0
  [../]
  [./heat_source_z]
    type = PiecewiseLinear
    data_file = ./input_params/path_t_z_h10.csv
    format = columns
    scale_factor = 1.0
  [../]
  [./specific_heat]
