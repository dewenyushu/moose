...
[Mesh]
  [./mesh]
    ...
    # file = ./../AM_Brick_inputs/solid_brick_20_substrate_30x30.e
    # file = ./../AM_Brick_inputs/solid_brick_20_substrate_30x30_coarse.e
    # file = ./../AM_Brick_inputs/solid_brick_h10_substrate_20x20.e
    file = ./../AM_Brick_inputs/solid_brick_h4_d01_substrate_30x30x4.e
  [../]
  [./add_set1]
...
[Functions]
  [./heat_source_x]
    ...
    data_file = ./../AM_Brick_inputs/path_x_box_h20_no_outline.csv
    format = columns
    scale_factor = 1.0
  [../]
  [./heat_source_y]
    type = PiecewiseLinear
    data_file = ./../AM_Brick_inputs/path_y_box_h20_no_outline.csv
    format = columns
    scale_factor = 1.0
  [../]
  [./heat_source_z]
    type = PiecewiseLinear
    data_file = ./../AM_Brick_inputs/path_z_box_h20_no_outline.csv
    format = columns
    scale_factor = 1.0
  [../]
  [./specific_heat]
    type = PiecewiseLinear
    data_file = ./../AM_Brick_inputs/Specific_Heat.csv
    format = columns
    scale_factor = 1.0
  [../]
  [./thermal_conductivity]
    type = PiecewiseLinear
    data_file = ./../AM_Brick_inputs/Thermal_Conductivity.csv
    format = columns
