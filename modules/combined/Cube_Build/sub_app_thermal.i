...
[Functions]
  [heat_source_x]
    ...
    data_file = ./path_x_box.csv
    format = columns
    scale_factor = 1.0
  []
  [heat_source_y]
    type = PiecewiseLinear
    data_file = ./path_y_box.csv
    format = columns
    scale_factor = 1.0
  []
  [heat_source_z]
    type = PiecewiseLinear
    data_file = ./path_z_box.csv
    format = columns
    scale_factor = 1.0
  []
  [specific_heat_metal]
...
[Outputs]
  file_base = 'output/Cube_thermal_speed_${speed}_power_${power}'
  csv = true
  [exodus]
    type = Exodus
    file_base = 'output/Exodus_speed_${speed}_power_${power}/Thermal'
