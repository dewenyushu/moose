...
[Mesh]
  ...
  [add_set3]
    ...
    input = add_set2
    block_id = 2
    bottom_left = '-0.05 -1 1'
    top_right = '0 -0.95 1.05'
  []
  [moving_boundary]
...
[Outputs]
  ...
  [exodus]
    type = Exodus
    file_base = 'output/Exodus_speed_${speed}_power_${power}/Line_thermal'
