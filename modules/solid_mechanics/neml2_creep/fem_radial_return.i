neml2_input = 'viscoplasticity_radial_return'
...
[UserObjects]
  active = 'model input_strain input_old_Ep input_old_gamma'
  [input_temperature]
  ...
  [model]
    ...
    gather_uos = 'input_strain input_old_Ep input_old_gamma'
  []
[]

[Materials]
  # add other outputs here if needed
  active = 'output_stress_jacobian output_Ep output_gamma'
