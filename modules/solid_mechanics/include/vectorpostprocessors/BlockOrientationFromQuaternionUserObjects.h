...
class BlockOrientationFromQuaternionUserObjects : public GeneralVectorPostprocessor
{
public:
  static InputParameters validParams();

  BlockOrientationFromQuaternionUserObjects(const InputParameters & parameters);
...
protected:
  ...
  /// User objects to grab average value from
  const std::vector<UserObjectName> & _uo_names;
  std::vector<const BlockAverage *> _uos;
