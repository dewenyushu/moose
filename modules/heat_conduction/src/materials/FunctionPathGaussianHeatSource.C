...
registerMooseObject("HeatConductionApp", FunctionPathGaussianHeatSource);
...
Real
FunctionPathGaussianHeatSource::computeAveragedHeatSource(
...
Real
FunctionPathGaussianHeatSource::computeMixedHeatSource(
    const Real x, const Real y, const Real z, const Real time_begin, const Real time_end)
{
  mooseAssert(time_end > time_begin, "Begin time should be smaller than end time.");
