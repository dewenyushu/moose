...
class MultiCrystalPlasticityKalidindiUpdate;
...
class MultiCrystalPlasticityKalidindiUpdate : public CrystalPlasticityStressUpdateBase
{
public:
  static InputParameters validParams();

  MultiCrystalPlasticityKalidindiUpdate(const InputParameters & parameters);
