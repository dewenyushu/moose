...
// declarations of the specialized functions
template <>
void
...
template <>
void RadialReturnStressUpdateTempl<false>::updateState(RankTwoTensor & strain_increment,
                                                       RankTwoTensor & inelastic_strain_increment,
                                                       const RankTwoTensor & rotation_increment,
                                                       RankTwoTensor & stress_new,
                                                       const RankTwoTensor & stress_old,
...
template <>
void RadialReturnStressUpdateTempl<true>::updateState(ADRankTwoTensor & strain_increment,
                                                      ADRankTwoTensor & inelastic_strain_increment,
                                                      const ADRankTwoTensor & rotation_increment,
                                                      ADRankTwoTensor & stress_new,
                                                      const RankTwoTensor & stress_old,
...
template <>
void RadialReturnStressUpdateTempl<true>::updateStateSubstep(
